...
private:
    ...
    void nearestNeighborsSearch(const ItemT* query_point, std::size_t begin, std::size_t end, std::size_t depth, KNNQueue<ItemT, DistanceT>& nearest_neighbors) const;
...
public:
    ...
    void nearestNeighborsSearch(const ItemT* query_point, KNNQueue<ItemT, DistanceT>& queue) const;
};
 ...
 */
    template <typename ItemT, typename DistanceT>
    void KDTree<ItemT, DistanceT>::buildTree(const std::size_t subarray_begin, const std::size_t subarray_end, const unsigned int depth) {
 ...
 */
    template <typename ItemT, typename DistanceT>
    void KDTree<ItemT, DistanceT>::nearestNeighborsSearch(const ItemT* query_point, KNNQueue<ItemT, DistanceT>& queue) const {
 ...
 */
    ...
    void KDTree<ItemT, DistanceT>::nearestNeighborsSearch(const ItemT* query_point, std::size_t begin, std::size_t end, std::size_t depth, KNNQueue<ItemT, DistanceT>& nearest_neighbors) const {
